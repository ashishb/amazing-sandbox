...
func ConfigureLogging() {
	...
	// color output is enabled by default, but can be disabled by setting COLOR_LOG_OUTPUT to "false"
	colorLogOutput := !strings.EqualFold(strings.TrimSpace(os.Getenv("COLOR_LOG_OUTPUT")), "false")
